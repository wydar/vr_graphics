	...
	var NumberControllerSlider = function (_NumberController) {
	  ...
	  function NumberControllerSlider(object, property, min, max, step) {
	    ...
	    _dom2.default.bind(_this2.__background, 'mousedown', onMouseDown);
			_dom2.default.bind(_this2.__background, 'touchstart', onTouchDown);
	    ...
	    function onMouseDown(e) {
	      ...
	      _dom2.default.bind(window, 'touchmove', onTouchDrag);
	      _dom2.default.bind(window, 'touchend', onTouchUp);
	    ...
	    function onMouseDrag(e) {
	      ...
	      e.preventDefault();
				...
				var equis = touchobj.clientX;
								
	
	      var bgRect = _this.__background.getBoundingClientRect();
	
	      _this.setValue(map(touchobj.clientX, bgRect.left, bgRect.right, _this.__min, _this.__max));
	    ...
	    function onMouseUp() {
	      ...
	      if (_this.__onFinishChange) {
			...
			function onTouchUp() {
	      _dom2.default.unbind(window, 'touchmove', onTouchDrag);
	      _dom2.default.unbind(window, 'touchend', onTouchUp);
	      if (_this.__onFinishChange) {
	        _this.__onFinishChange.call(_this, _this.getValue());
	      }
	    }
